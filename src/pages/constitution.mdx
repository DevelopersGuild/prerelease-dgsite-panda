...
<Helmet title="Constitution | Developers Guild" defer={false} />
<NavBarMain />
<Container>
<br />
...
<Img
  ...
  fluid={props.data.constitution.childImageSharp.fluid}
  alt={props.data.constitution.id}
/>
...
export const ConstitutionPageQuery = graphql`
  query ConstitutionPageQuery {
    constitution: file(relativePath: { eq: "the-creation-of-design.png" }) {
      id
      childImageSharp {
