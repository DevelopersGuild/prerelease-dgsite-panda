...
<Helmet title="Contributing | Developers Guild" defer={false} />
<NavBarMain />
<Container>
<br />
...
<Img
  ...
  fluid={props.data.contributing.childImageSharp.fluid}
  alt={props.data.contributing.id}
/>
...
export const ContributingPageQuery = graphql`
  query ContributingPageQueryPageQueryPageQuery {
    contributing: file(relativePath: { eq: "open-source.png" }) {
      id
      childImageSharp {
